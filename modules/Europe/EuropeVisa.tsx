      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12 py-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md">
              ...
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1">🔍</span>
                <span className="text-gray-800">
                  Accurate DS-160 / local forms guidance
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1">🔒</span>
                <span className="text-gray-800">
                  Secure handling & fast response
                </span>
              </li>
            </ul>
        ...
        <section className="mt-10 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed max-w-3xl">
            The Schengen area covers many European countries allowing short
            visits (typically up to 90 days in any 180-day period). Depending on
            your travel plan (single country or multi-country), we will advise
            which consulate to apply through and prepare a complete,
            embassy-ready application.
          </p>
        </section>
        ...
        <section className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-700">
              Standard processing typically takes between 10–30 working days.
              Priority or expedited slots may be available at additional cost —
              availability depends on the embassy/VFS center.
            </p>

            <div className="mt-6 bg-gray-50 p-4 rounded-lg border">
              <h4 className="font-semibold">Fast-Track Tip</h4>
              <p className="mt-2 text-gray-700 text-sm">
                If you have urgent travel, contact us immediately — we’ll
                attempt to secure earlier appointments and advise on any
                priority services offered by the consulate.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="apply" className="mt-12">
          ...
          <ol className="mt-4 list-decimal pl-6 space-y-3 text-gray-700">
            ...
            <li>
              We prepare the application, fill forms, and submit to the correct
              consulate.
            </li>
            <li>
              Attend your VFS appointment for biometrics (we help schedule).
            </li>
            <li>
              Receive visa decision and collect passport (courier or
              self-collect).
            </li>
          </ol>
        ...
        >
          <h3 className="text-xl font-semibold text-black">
            Ready to Apply for Your Europe Visa?
          </h3>
          <p className="mt-2 text-gray-700">
            Send your documents on WhatsApp or email and our visa specialists
