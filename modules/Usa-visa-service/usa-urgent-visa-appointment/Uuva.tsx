  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32 space-y-10 text-black">
      ...
      <div className="space-y-4 text-gray-800">
        ...
        <p className="text-blue-600 font-semibold text-xl">Just From AED 2500</p>
        <p>
          Getting a USA visa appointment has become increasingly difficult, with
          many travelers facing long waiting times. At <span className="font-semibold">Dream Wise Connect</span>, we
        ...
        <p>
          ...
          appointment within <span className="font-semibold">10–30 days</span>, supported by our
      ...
      <ul className="space-y-2 text-gray-800 list-disc pl-6">
        ...
        <li>Complete assistance with DS-160, booking, and interview preparation.</li>
