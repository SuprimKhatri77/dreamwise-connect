      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-10 text-gray-800">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base md:text-lg max-w-3xl mx-auto text-gray-600">
            Planning a trip to the USA from Dubai for tourism, business, or a family
            visit? DreamWise Connect makes the entire visa process simple, fast, and
            stress‑free for UAE residents.
          </p>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="rounded-2xl shadow-md p-6">
              ...
              <CardContent className="text-gray-600">
                Send your passport copy, Emirates ID, and bank statement. We&apos;ll give
                you a full checklist.
              </CardContent>
            </Card>
        ...
        <section className="mb-16">
          ...
          <Card className="rounded-2xl shadow-md p-6 text-gray-700 space-y-3">
            ...
            <p>📝 We ensure your DS‑160 form and documents are correctly handled.</p>
          </Card>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="rounded-2xl border-2 border-blue-600 shadow-md p-6 text-gray-700">
              Complete DS‑160 form filling, appointment booking & interview tips.
            </Card>
          </div>
        </section>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto mb-6">
            Contact DreamWise Connect today. Let our visa experts handle every step
            while you plan your American journey with confidence.
          </p>
