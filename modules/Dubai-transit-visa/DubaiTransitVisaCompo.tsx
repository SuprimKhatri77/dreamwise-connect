          ...
          <div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-sm md:text-base text-gray-800 leading-relaxed">
                ...
                It’s ideal for passengers who wish to make the most of their stopover by exploring the city or relaxing before their onward journey.
              </p>

              {/* Bullet Points */}
              <ul className="list-decimal list-inside space-y-2 text-sm md:text-base text-gray-800">
                <li>Discover Dubai’s famous attractions like the Burj Khalifa and Dubai Mall.</li>
                <li>Meet friends or family during your short stopover.</li>
                <li>Check into a hotel and rest comfortably outside the airport.</li>
              </ul>

              {/* More Info */}
              <p className="text-sm md:text-base text-gray-800 leading-relaxed">
                A transit visa is issued only when your next confirmed flight is within a short time frame.
                You can choose between a <span className="font-semibold">48-hour</span> or <span className="font-semibold">96-hour</span> visa option.
                <br /><br />
                Please note that transit visas cannot be renewed or extended. Once the validity period expires, travelers must continue their onward journey.
              </p>
              ...
              <div className="p-5 bg-white rounded-xl shadow-md border border-gray-200">
                ...
                <p className="text-sm md:text-base text-gray-800">
                  ...
                  <span className="font-semibold">Dream Wise Connect</span>.
                  We provide fast processing for transit visas along with travel insurance—delivered within
        ...
        <div className="text-gray-900 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border flex flex-col items-center text-center">
              <Image src="/filesend.svg" height={120} width={150} alt="Send passport" />
              <h2 className="mt-4 text-gray-900 font-medium text-sm md:text-base">
                <span className="font-bold">1)</span> Send your passport copy to us via Email or WhatsApp.
              </h2>
            </div>

            {/* Step 2 */}
            <div className="bg-white p-5 rounded-xl shadow-sm border flex flex-col items-center text-center">
              <Image src="/Payment.svg" height={120} width={150} alt="Payment" />
              <h2 className="mt-4 text-gray-900 font-medium text-sm md:text-base">
                <span className="font-bold">2)</span> Make a secure online or offline payment.
              </h2>
            </div>

            {/* Step 3 */}
            <div className="bg-white p-5 rounded-xl shadow-sm border flex flex-col items-center text-center">
              <Image src="/Ok.svg" height={120} width={150} alt="Visa approval" />
              <h2 className="mt-4 text-gray-900 font-medium text-sm md:text-base">
                <span className="font-bold">3)</span> Get your visa to your email or WhatsApp
              </h2>
            </div>
          ...
          <div className="space-y-6">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Benefits of Our Service</h2>
          ...
          {/* Visa Types Section */}
          <div className="space-y-6">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Dubai Transit Visa Types</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* 48-hour visa */}
              <div className="bg-white rounded-xl shadow-sm border p-6 space-y-3">
                <h3 className="font-bold text-lg text-gray-900">48-Hour Transit Visa</h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Ideal for short layovers under two days. Perfect if you&apos;re stopping in Dubai before your final destination.
                </p>
                <p className="font-medium text-blue-600 text-sm">Price: AED 350 (includes mandatory travel insurance)</p>
              </div>

              {/* 96-hour visa */}
              <div className="bg-white rounded-xl shadow-sm border p-6 space-y-3">
                <h3 className="font-bold text-lg text-gray-900">96-Hour Transit Visa</h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Suitable for travelers wishing to explore Dubai more comfortably during a 4-day stopover.
                </p>
                <p className="font-medium text-blue-600 text-sm">Price: AED 450 (includes mandatory travel insurance)</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Eligibility Requirements</h2>
            <ul className="space-y-2 text-gray-800 text-sm md:text-base">
              ...
              <li className="text-gray-600 text-xs">
                *Some nationalities may need to apply before arrival—contact us to confirm.
              </li>
            </ul>
          </div>
          ...
          {/* Required Documents */}
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Documents Required</h2>
            <ul className="space-y-2 text-gray-800 text-sm md:text-base">
              <li>• Passport copy</li>
          ...
          {/* Processing Time */}
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Processing Time</h2>
            <p className="text-gray-800 text-sm md:text-base">
              <span className="font-medium">Standard:</span> 2 working days
              <br />
              <span className="font-medium">Urgent:</span> Within 24 hours (extra AED 500)
            </p>
          </div>
          ...
          {/* Payment Info */}
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Payment Options</h2>
            <p className="text-gray-800 text-sm md:text-base">
              Once we receive your documents, we will share all available online & offline payment methods.
              We accept:
            </p>
          ...
          {/* FAQ Section */}
          <div className="space-y-6">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Frequently Asked Questions</h2>
          ...
          <div className="space-y-3 text-gray-900">
            <h2 className="text-lg md:text-xl font-semibold">Need More Help?</h2>
            <p className="text-sm md:text-base">
              WhatsApp: <span className="font-semibold">+971502315207</span>
              <br />
              Email: <span className="font-semibold">info@dreamwiseconnect.com</span>
              <br />
              We reply to all emails within <span className="font-semibold">1 business hour</span>.
            </p>
          </div>
